...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'rawi_20230315_fca0b585223eadde8278_20230315083959_archive.zip';
        const ARCHIVE_SIZE       = '565613660';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'fca0b58-15083959';
        const SECONDARY_PACKAGE_HASH = '9812ebc-15083959';
